<?php
	...
	$request = file_get_contents("https://www.googleapis.com/youtube/v3/search?part=snippet&q=".$mood."music&type=video&videoDuration=short&videoCaption=any&key=AIzaSyBfGJ7nuAra9imWqN8q3UsHTWyiKvGLTdU&maxResults=50");
	//print_r($response);
